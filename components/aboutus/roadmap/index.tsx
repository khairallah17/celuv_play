            ...
            <div className='container mx-auto'>
                ...
                className="flex items-cente justify-center flex-wrap gap-y-10 mt-20">
                    ...
                    <div ref={ref2} className='inline-block'>
                        <Image src="/2Q.svg" height={0} width={0} className='grow-0 w-auto h-auto drop-shadow-card-sh' alt='q2' />
                    </div>
                    <div ref={ref3} className='inline-block'>
                        <Image src="/3Q.svg" height={0} width={0} className='grow-0 w-auto h-auto drop-shadow-card-sh' alt='q3' />
                    </div>
                    <div ref={ref4} className='inline-block'>
                        <Image src="/4Q.svg" height={0} width={0} className='grow-0 w-auto h-auto drop-shadow-card-sh' alt='q4' />
                    </div>
                </div>
            </div>
