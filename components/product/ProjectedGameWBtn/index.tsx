...
const ProjectedGameWBtn = (props:Game) => {
    return (
        <div className='bg-astian-lighter rounded-x-btn flex flex-col items-center  justify-center border border-astian gap-6 drop-shadow-game-bx relative z-auto w-[365px] h-[588px]'>
            ...
            <p className='w-[60%] text-center font-medium text-astian text-md uppercase h-[50px]'>
                {props.subtitle}
            </p>
