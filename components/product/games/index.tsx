...
const Games = () => {
  return (
    <div className="flex items-center justify-center flex-wrap w-full gap-6 gap-y-16 my-10 mb-20 relative">
        <div className="absolute bg-gradient-to-b from-[#DEEFFF] to-transparent h-1/2 bg-opacity-50 w-full -top-10"></div>
