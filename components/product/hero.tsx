  ...
  return (
    <div className='flex w-full h-full justify-center relative flex-col bg-[#DEEFFF] py-20'>
        ...
        <div className='container mx-auto flex flex-col justify-center relative z-50 gap-10'>
            ...
            <motion.h3 className='uppercase font-bold text-7xl bg-gradient-to-r from-astian-light to-astian bg-clip-text text-transparent text-center'>astian dapp</motion.h3>
            <motion.p className='text-third font-normal text-center text-lg'>
            ...
            <motion.div className='flex items-center gap-4 justify-center'>
            ...
            <motion.div className='flex items-center justify-center gap-6 mt-16'>
